				...
				<div class="row gy-4">
                    <form method="post">
                        <div class="col-md-6 mb-3">
                            <label for="accountnumber">Customers Account Number</label>
                            <input type="text" class="form-control" name="Cust_ac_no" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="customer id">Customer ID</label>
                            <input type="text" class="form-control" name="Cust_ac_Id" required>
                        </div>
                        <div class="col-md-6 mb-3">
...
$sql = "SELECT Account_no, Customer_ID FROM customers_account WHERE Account_no='$acc_no'";
...
if($result->num_rows > 0){
    ...
    $sql2 = "DELETE FROM customers_account WHERE Account_no='$acc_no'";

    if( ($connection->query($sql1)  && $connection->query($sql2)) == TRUE ){
