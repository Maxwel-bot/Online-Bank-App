...
<body>
            ...
            <div class="col-md-6 col-12 mx-auto border">
                ...
                <form method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="Phone_Number" name="mobile" required>
                 </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                    <label fot="text">Landline Number</label>
                    <input type="text" class="form-control" id="password" name="landline">
                 </div>
               <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Residential_Adderess" name="homeaddrs" required>
                    <label for="Street-Address">Street Address</label>
                    <input type="text" class="form-control" id="Street_Address" name="officeaddrs" required>
                    <label for="City">City</label>
                    <input type="text" class="form-control" id="City" name="city" required>
                    <label for="State/Province">State / Province</label>
                    <input type="text" class="form-control" id="state" name="state"required>
                    <label for="area">Area/Location</label>
                    <input type="text" name="arealoc" placeholder="Area/Locality" class="form-control" required />
                    <label for="zip-code">Postal / Zip Code</label>
                    <input type="text" class="form-control"name="pin" id="postal/zipcode" required>
    ...
    <option value="Zimbabwe">Zimbabwe</option>
                 ...
                 <div class="form-group">
                    <span><i> By signing this form, I acknowldge that the information I have given is accurate and i agree to all the Terms and Conditions</i></span>
                 </div>
                 <div class="form-group">
